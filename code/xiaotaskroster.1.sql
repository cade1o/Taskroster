...
CREATE TABLE IF NOT EXISTS `xiaoschema`.`grouptask` (
  ...
  PRIMARY KEY (`group_id`, `manager_manager_id`),
  INDEX `fk_grouptask_manager1_idx` (`manager_manager_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `xiaoschema`.`staff_has_manager` (
  ...
  INDEX `fk_staff_has_manager_manager1_idx` (`manager_manager_id` ASC) VISIBLE,
  INDEX `fk_staff_has_manager_staff1_idx` (`staff_staff_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `xiaoschema`.`tasks` (
  ...
  INDEX `fk_tasks_grouptask_idx` (`grouptask_group_id` ASC) VISIBLE,
  INDEX `fk_tasks_manager1_idx` (`manager_manager_id` ASC) VISIBLE,
